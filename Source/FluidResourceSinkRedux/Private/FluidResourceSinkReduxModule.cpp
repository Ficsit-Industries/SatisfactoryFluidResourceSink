...
#include "FluidResourceSinkReduxModule.h"
...
DEFINE_LOG_CATEGORY(LogFluidResourceSinkRedux);



void FFluidResourceSinkReduxModule::StartupModule() {
#if !WITH_EDITOR
...
IMPLEMENT_GAME_MODULE(FFluidResourceSinkReduxModule, FluidResourceSink);
